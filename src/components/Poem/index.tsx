...
export default function Poem({ text }: PoemProps) {
    ...
    const art = {
        ...
        poem: "art:w:h:full art:overflow:auto art:scrollbar:none art:p:lg art:font:!black-02 art:flex art:gap:sm art:col art:x-content:center art:y-items:center"
    }

    return (
        <div className={art.box} style={{ "background": "#F6EEE3"}}>

            <article className={art.poem}>
                {
                    text.map((line) => (
